=== ezWordpREST ===
Contributors: Johan Risch
Tags: wordpress, REST, JSON
...
Installing "ezWordpREST" can be done either by searching for "ezWordpREST" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
